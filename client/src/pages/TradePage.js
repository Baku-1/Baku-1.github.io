...
const TradePage = () => {
  ...
  const handleSelectTrades = () => {
    // Logic for selecting trades
    console.log("Select Trades button clicked");
  };
    ...
    <div>
      ...
      <main className="container">
        ...
        <div className="button-container">
          ...
          <button className="btn-trade" onClick={handleSelectTrades}>Select Trades Available</button>
        </div>
        <div className="row">
          {trades.map((trade) => (
            <TradeCard key={trade._id} trade={trade} />
